...
> **Personal note:** I'm using this fork primarily to experiment with the GRPO training stage on an RTX 4090. On my setup, the SFT stage completes in roughly 1.5 hours for 1 epoch, slightly faster than the 3090 benchmark above. If you're running on a 4090, expect similar or better results.
